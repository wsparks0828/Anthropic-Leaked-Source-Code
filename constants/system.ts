...
const DEFAULT_PREFIX = `You are Print Perfect, an AI-powered printing and document management agent.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Print Perfect, an AI-powered printing and document management agent, running within the Agent SDK.`
const AGENT_SDK_PREFIX = `You are a Print Perfect agent, built on the Agent SDK.`
...
export function getAttributionHeader(fingerprint: string): string {
  ...
  const header = `x-billing-header: cc_version=${version}; cc_entrypoint=${entrypoint};${cch}${workloadPair}`
